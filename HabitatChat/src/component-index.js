...
import views$dialogs$ConfirmDestroyCrossSigningDialog from './components/views/dialogs/ConfirmDestroyCrossSigningDialog';
views$dialogs$ConfirmDestroyCrossSigningDialog && (components['views.dialogs.ConfirmDestroyCrossSigningDialog'] = views$dialogs$ConfirmDestroyCrossSigningDialog);
...
import views$dialogs$SetupEncryptionDialog from './components/views/dialogs/SetupEncryptionDialog';
views$dialogs$SetupEncryptionDialog && (components['views.dialogs.SetupEncryptionDialog'] = views$dialogs$SetupEncryptionDialog);
...
import views$dialogs$secretstorage$AccessSecretStorageDialog from './components/views/dialogs/secretstorage/AccessSecretStorageDialog';
views$dialogs$secretstorage$AccessSecretStorageDialog && (components['views.dialogs.secretstorage.AccessSecretStorageDialog'] = views$dialogs$secretstorage$AccessSecretStorageDialog);
...
import views$elements$IconButton from './components/views/elements/IconButton';
views$elements$IconButton && (components['views.elements.IconButton'] = views$elements$IconButton);
...
import views$rooms$InviteOnlyIcon from './components/views/rooms/InviteOnlyIcon';
views$rooms$InviteOnlyIcon && (components['views.rooms.InviteOnlyIcon'] = views$rooms$InviteOnlyIcon);
...
import views$rooms$UserOnlineDot from './components/views/rooms/UserOnlineDot';
views$rooms$UserOnlineDot && (components['views.rooms.UserOnlineDot'] = views$rooms$UserOnlineDot);
...
import views$toasts$BulkUnverifiedSessionsToast from './components/views/toasts/BulkUnverifiedSessionsToast';
views$toasts$BulkUnverifiedSessionsToast && (components['views.toasts.BulkUnverifiedSessionsToast'] = views$toasts$BulkUnverifiedSessionsToast);
import views$toasts$SetupEncryptionToast from './components/views/toasts/SetupEncryptionToast';
views$toasts$SetupEncryptionToast && (components['views.toasts.SetupEncryptionToast'] = views$toasts$SetupEncryptionToast);
import views$toasts$UnverifiedSessionToast from './components/views/toasts/UnverifiedSessionToast';
views$toasts$UnverifiedSessionToast && (components['views.toasts.UnverifiedSessionToast'] = views$toasts$UnverifiedSessionToast);
